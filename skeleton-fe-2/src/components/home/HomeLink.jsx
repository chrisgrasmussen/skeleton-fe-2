...
const HomeLink = () => {
    return (
        <div className="pt-10 flex flex-row items-center justify-center">
            <Link to={'/start'} >
                <button className=' bg-indigo-400 hover:bg-indigo-500 opacity-80 w-[600px] flex flex-row justify-between items-center p-5 rounded-2xl'>
                    <h1 className=' text-white text-sm'>See More Conversations</h1>
